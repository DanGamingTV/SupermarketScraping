...
app.get('/', function(req, res) {
    res.send(`Current endpoints:<br>/paknsave<br>/newworld<br>/countdown<br>/thewarehouse<br>/freshchoice<br>/supervalue<br>/mightyape<br><br>Example usage: GET /paknsave/latest.json<br>Returns: JSON price data`)
})
